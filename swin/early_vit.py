...
class swinEarlyFusion(nn.Module):
    def __init__(self, num_classes=2):
        super(swinEarlyFusion, self).__init__()
        self.model = timm.create_model('swin_large_patch4_window7_224.ms_in22k', pretrained=True)
...
def main():
    ...
    model = swinEarlyFusion(num_classes=2).to(device)
