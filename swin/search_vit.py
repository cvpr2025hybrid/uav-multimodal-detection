...
class HybridFusionResNet(nn.Module):
    def __init__(self, fusion_layer, num_classes=2):
        ...
        self.rgb_branch = timm.create_model('swin_large_patch4_window7_224.ms_in22k', pretrained=False, features_only=True)
        self.thermal_branch = timm.create_model('swin_large_patch4_window7_224.ms_in22k', pretrained=False, features_only=True)
        self.event_branch = timm.create_model('swin_large_patch4_window7_224.ms_in22k', pretrained=False, features_only=True)
