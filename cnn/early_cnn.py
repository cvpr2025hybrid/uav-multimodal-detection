...
class CNNEarlyFusion(nn.Module):
    def __init__(self, num_classes=2):
        super(CNNEarlyFusion, self).__init__()
        self.model = timm.create_model('cnn', pretrained=True)
...
def main():
    ...
    model = CNNEarlyFusion(num_classes=2).to(device)
