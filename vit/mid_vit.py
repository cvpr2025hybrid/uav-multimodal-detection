...
class HybridFusionResNet(nn.Module):
    def __init__(self, num_classes=2):
        ...
        self.rgb_branch = timm.create_model('vit', pretrained=True, features_only=True)
        self.thermal_branch = timm.create_model('vit', pretrained=True, features_only=True)
        self.event_branch = timm.create_model('vit', pretrained=True, features_only=True)
